...
function listenForDownloadHeaders (ses) {
  ses.webRequest.onHeadersReceived(function (details, callback) {
    ...
    */
    if (details.webContents && (details.webContents.getURL().startsWith('wolf://app/pages/pdfViewer') || details.webContents.getURL().startsWith('wolf://app/reader/') || details.webContents.getURL() === 'wolf://app/index.html')) {
      ...
      callback({
        responseHeaders: {
          ...filteredHeaders,
          'Access-Control-Allow-Origin': 'wolf://app',
